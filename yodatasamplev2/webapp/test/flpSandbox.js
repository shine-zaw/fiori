		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "yodatasamplev2",
									"targetURL": "#yodatasamplev2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"yodatasamplev2-display": {
								"semanticObject": "yodatasamplev2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=yodatasamplev2",
									"url": sap.ui.require.toUrl("yodatasamplev2")
								}
							}
						}
					}
