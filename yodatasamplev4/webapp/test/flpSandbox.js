		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "yodatasamplev4",
									"targetURL": "#yodatasamplev4-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"yodatasamplev4-display": {
								"semanticObject": "yodatasamplev4",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=yodatasamplev4",
									"url": sap.ui.require.toUrl("yodatasamplev4")
								}
							}
						}
					}
